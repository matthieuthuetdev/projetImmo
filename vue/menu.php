        ...
        <div class="navbar navbar-inverse">
          ...
          <div class="navbar-collapse collapse" id="collapse-1">
            <ul class="nav navbar-nav">
              ...
              <?php echo !isset($_SESSION["name"]) ?  ' <li><a href="./index.php?pageController=user&action=signIn">Se connecter</a></li>':'';?>
              <?php echo isset($_SESSION["name"]) ?  ' <li><a href="./index.php?pageController=user&action=signOut">Se déconnecter</a></li>':'';?>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!-- /.navbar-inner -->
      </div><!-- /.navbar -->
