...
VALUES
  (
    1,
    'Maison de maître au bord du Lac ',
    5,
    '150.00',
    '550000.00',
    'Belle maison de style située au bord du lac D\'Annecy...Emplacement avec vue sur le lac.',
    'D',
    'C',
    0,
    'Idéalement situé à 2 pas du centre de la vieille ville, quartier sud  ',
    74,
    'Annecy',
    '0.00',
    1,
  ...
  (
    ...
    '94.00',
    '220000.00',
    'Beau F3 situé au 1er étage d\'une résidence avec vue sur le lac.',
    'B',
    'C',
    0,
    'A 2 pas du centre ville et des commerces , dans le quartier vieille ville, rue de l\'Ours',
    74,
    'Annecy',
    '2000.00',
    2,
  ...
  (
    3,
    'Bel appartement 90 m² - 4 pièces - 3 chambres',
    4,
    '90.00',
    '278200.00',
    'Quartier des Maraîchers, Lumineux 4 pièces de 90 m2 dans une résidence de standing de 2015 avec portail motorisé..\r\nAu rez-de-chaussée : Cuisine ouverte sur salon séjour avec un accès sur la terrasse, 1 chambre, WC indépendant avec lave-main. A l\'étage: 1 chambre de 18 m2 avec dressing , une salle de bain avec fenêtre et une mezzanine de 25m2 au sol.\r\nUn garage ainsi qu\'une place de parking complète ce lot.',
    'D',
    'B',
    0,
    'Idéalement situé à proximité des commerces, transports en commun et du centre de Colmar.',
    68,
    'Colmar',
    '3000.00',
    1,
  ...
  (
    4,
    'appartement F2 pièces de 67m2 avec orientation SUD',
    4,
    '67.00',
    '235000.00',
    'appartement 2 pièces de 67m2 avec orientation SUD, composant : 2 chambres, une cuisine ouverte sur le salon séjour, salle de bain, WC indépendant, terrasse de 12m2 et jardin de 77m2.\r\nLe bien est vendu avec cave. Le garage est en option. \r\nA proximité de tout accès et commodité.\r\nÉligible à la loi PINEL et au prêt a taux zéro.\r\n',
    'B',
    'B',
    0,
    'situé au centre ville de Colmar,A proximité de tout accès et commodité.',
    68,
    'Colmar',
    '1500.00',
    2,
  ...
  (
    5,
    'MAISON 4 PIÈCES AVEC TERRASSE - PROCHE CASTRES',
    4,
    '80.00',
    '129000.00',
    'découvrez cette maison de 4 pièces de 80 m² et de 1 500 m² de terrain. Elle dispose d\'une pièce à vivre et de trois chambres. Elle offre également une salle d\'eau. Un chauffage fonctionnant à l\'électricité est installé dans la maison.\r\n\r\nCe bien dispose aussi d\'une terrasse (30 m²) et d\'un jardin (1 500 m²), l\'idéal pour profiter des beaux jours.\r\n\r\nL\'intérieur nécessite d\'être rafraîchi. Concernant les véhicules, cette maison possède une place sur un parking extérieur et deux places de parking en intérieur.',
    'D',
    'C',
    0,
    'La maison se situe dans la commune d\'Anglès. On trouve une école primaire à moins de 10 minutes du bien. Il y a un restaurant à moins de 10 minutes.',
    81,
    'Anglès',
    '0.00',
    1,
  ...
  (
    6,
    'Maison mitoyenne 1 côté à vendre dans un ensemble immobilier de 4 logements réhabilité à neuf',
    3,
    '60.00',
    '152000.00',
    'Idéalement situé à 5 minutes de l\'Eurométropole Strasbourgeoise, maison mitoyenne 1 côté à vendre dans un ensemble immobilier de 4 logements réhabilité à neuf en 2020.\r\n\r\nSur 2 niveaux, le logement comprend 2 chambres, 1 salle de bain, 2 WC, un séjour spacieux ouvert sur une cuisine et une terrasse. Places de stationnement extérieures et/ou garages peuvent venir compléter le bien en sus.\r\n\r\n',
    'D',
    'C',
    0,
    'Lumineux et calme, il se trouve proche de toutes commodités et des transports en commun, à 5 minutes de l\'autoroute et à 15 minutes du centre-ville de Strasbourg.',
    67,
    'Berstett',
    '2000.00',
    2,
  ...
  (
    7,
    'Terrain Constructible Burlats 3730 m²',
    0,
    '3730.00',
    '87000.00',
    'Terrain de 3730m2(soit 37 a) dans un endroit très calme sans vis a vis avec une vue magnifique.\r\nA 5mn de castres.\r\n\r\n ',
    'a',
    'a',
    0,
    'A 5mn de castres.',
  ...
  (
    9,
    '\'Grand Appartement Colmar F4 à saisir \'',
    4,
    '94.00',
    '200000.00',
    '\' test \'',
...
--
INSERT INTO
  `categories` (`id_categorie`, `lib_categorie`)
VALUES
  (1, 'Appartement'),
...
--
INSERT INTO
  `departements` (`id_dep`, `nom_dep`, `dep_actif`)
VALUES
  (1, '01 - Ain', 1),
  (2, '02 - Aisne', 1),
  (3, '03 - Allier', 1),
...
VALUES
  ...
  (
    2,
    'Agent_commercial',
    'Accès à ses dossiers uniquement'
  );
...
VALUES
  ...
  (
    ...
    'Annecy',
    '038815151515',
    'ttournesol@gmail.com',
    'Gérant SCI ',
    'Etude de M. Séraphin lampion'
  );
...
VALUES
  (
    ...
    'CASTAFIORE',
    'Bianca',
    'bcastafiore@gmail.com',
    '$2y$10$2osdGr.NcLSyh6BcwkFIrO4.39XwM8G1gVltSKX5BZwE4Buxz6mZK',
    2
  ),
  (
    2,
    ...
    'Piotr',
    'Pszut@gmail.com',
    '$2y$10$xXYfyPb.VS2MmhUqCQGNWeJPm/rYqifT3HNHVxXr0.dqdC8XDb09a',
    2
  );
...
--
ALTER TABLE `association_img` ADD PRIMARY KEY (`id`, `id_image`),
ADD KEY `FK_img` (`id_image`);

--
-- Index pour la table `biens_immobiliers`
--
ALTER TABLE `biens_immobiliers` ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `departements` ADD PRIMARY KEY (`id_dep`);

--
-- Index pour la table `documents`
--
ALTER TABLE `documents` ADD PRIMARY KEY (`id_document`),
ADD KEY `id` (`id`);

--
-- Index pour la table `habilitations`
--
ALTER TABLE `habilitations` ADD PRIMARY KEY (`id_niveau`);
...
--
ALTER TABLE `proprietaires` ADD PRIMARY KEY (`id_proprietaire`);

--
-- Index pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs` ADD PRIMARY KEY (`id_utilisateur`),
...
--
ALTER TABLE `biens_immobiliers` MODIFY `id` int (11) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 12;

--
-- AUTO_INCREMENT pour la table `categories`
--
ALTER TABLE `categories` MODIFY `id_categorie` int (11) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;

--
-- AUTO_INCREMENT pour la table `departements`
--
ALTER TABLE `departements` MODIFY `id_dep` int (10) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 96;

--
-- AUTO_INCREMENT pour la table `habilitations`
--
ALTER TABLE `habilitations` MODIFY `id_niveau` int (10) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 3;

--
-- AUTO_INCREMENT pour la table `images`
--
ALTER TABLE `images` MODIFY `id_image` int (11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `proprietaires`
--
ALTER TABLE `proprietaires` MODIFY `id_proprietaire` int (10) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;

--
-- AUTO_INCREMENT pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs` MODIFY `id_utilisateur` int (10) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 3;
...
--
ALTER TABLE `association_img` ADD CONSTRAINT `FK_bien_immmo` FOREIGN KEY (`id`) REFERENCES `biens_immobiliers` (`id`),
ADD CONSTRAINT `FK_img` FOREIGN KEY (`id_image`) REFERENCES `images` (`id_image`);

--
-- Contraintes pour la table `biens_immobiliers`
--
ALTER TABLE `biens_immobiliers` ADD CONSTRAINT `biens_immobiliers_ibfk_1` FOREIGN KEY (`id_utilisateur_commercial`) REFERENCES `utilisateurs` (`id_utilisateur`),
...
--
ALTER TABLE `documents` ADD CONSTRAINT `documents_ibfk_1` FOREIGN KEY (`id`) REFERENCES `biens_immobiliers` (`id`);

--
-- Contraintes pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs` ADD CONSTRAINT `utilisateurs_ibfk_1` FOREIGN KEY (`id_niveau`) REFERENCES `habilitations` (`id_niveau`);
